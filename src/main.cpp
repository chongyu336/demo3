 ...
 * USART    USART1([PB6]=TX1, [PB7]=RX1) // computer
 *          USART2([PA2]=TX2, [PA3]=RX2) // imu
 *          USART3([PB10]=TX3, [PB11]=RX3) // modbus
 *          UART4([PC10]=TX4, [PC11]=RX4) // wifi
 *          UART5([PC12]=TX5, [PD2]=RX5) // sbus
 *          USART6([PC6]=TX6, [PC7]=RX6) // 485
 * CAN      CAN1([PB9]=TX1, [PB8]=RX1)
 *          CAN2([PB13]=TX2, [PB12]=RX2)
 * I2C      I2C2([PB10]=SCL2, [PB11]=SDA2) 与 USART3 共用引脚
 * SPI      SP1([PA4]=NSS, [PA5]=SCK, [PA6]=MISO, [PA7]=MOSI)
 * USB      ([PA11]=DM, [PA12]=DP)
 * TIM      TIM1([PA8]=CH1, [PA9]=CH2, [PA10]=CH3)
 *          TIM3([PB4]=CH1, [PB5]=CH2)
 *          TIM8([PC8]=CH3, [PC9]=CH4)
